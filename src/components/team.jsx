        ...
        <main className="team-main-wrapper">
          ...
          <section className="team-section-wrapper">
            <span className="team-artist-container">
              ...
              <div dangerouslySetInnerHTML={this.embedArtist1Instagram()}></div>
            </span>
            <span className="team-artist-container">
